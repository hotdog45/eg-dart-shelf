...
import static com.gusrylmubarok.ecommerce.rest.security.Constants.TOKEN_URL;
...
public class ApiAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    public void commence(HttpServletRequest req,
        ...
        Error error = ErrorUtils.createError(errorMsg, ErrorCode.UNAUTHORIZED.getErrCode(),
