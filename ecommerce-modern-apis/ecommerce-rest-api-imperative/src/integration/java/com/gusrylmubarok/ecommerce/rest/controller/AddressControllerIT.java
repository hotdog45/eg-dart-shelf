...
import com.gusrylmubarok.ecommerce.rest.AuthClient;
import com.gusrylmubarok.ecommerce.rest.TestUtils;
...
import static com.gusrylmubarok.ecommerce.rest.TestUtils.isTokenExpired;
...
public class AddressControllerIT {
    ...
    public void getAddressByInvalidUUID() throws IOException {
        ...
        assertThat(addressResponseEntity.getBody()).contains(
                "{\"errorCode\":\"SERVER-0009\",\"message\":\"Invalid data passed. Invalid UUID string: "
                        + id);
    }
    ...
    public void deleteAddressByIdWithNonAdmin() throws IOException {
        ...
        assertThat(addressResponseEntity.getBody()).contains(
                "{\"errorCode\":\"SERVER-0014\",\"message\":\"Access Denied. Access is denied");
    }
