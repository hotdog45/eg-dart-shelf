...
public interface OwnerOrBuilder extends
    // @@protoc_insertion_point(interface_extends:com.gusrylmubarok.v1.Owner)
   ...
   */
  com.gusrylmubarok.ecommerce.grpc.grpc.v1.Address getVerifiedAddress();
  /**
   * <pre>
   * Verified values are verified or provided by the payment method directly
   * (and if supported) at the time of authorization or settlement. They cannot be set or mutated.
   ...
   * <code>.com.gusrylmubarok.v1.Address verifiedAddress = 5;</code>
   */
  com.gusrylmubarok.ecommerce.grpc.grpc.v1.AddressOrBuilder getVerifiedAddressOrBuilder();
